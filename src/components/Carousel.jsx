...
//           <AiOutlineArrowLeft className='arrows'style={{...style, display: "block", fontSize: "28px", borderRadius: "50px", background:"#f53347", color:"white", position:"absolute", padding:"8px", left:"50px",}}/>
//         </div>
//       )
//     }
...
//           <AiOutlineArrowRight className='arrows'style={{...style, display: "block", borderRadius: "50px", background:"#f53347", color:"white", position:"absolute", padding:"8px", right:"50px"}}/>
//         </div>
//       )
//     }
...
//                       <h3 className='text-red-500 font-semibold font-sans text-sm'>Powering Your world with the Best in Product</h3>
