...
// import emptyCart from "../../assets/404 error not found.json"
...
//                     <input type="text" placeholder='Enter your state' className='p-2 rounded-md w-full bg-white' value={location?.state}/>
//                   </div>
//                   <div className='flex flex-col space-y-1 w-full'>
//                     <label htmlFor="">PostCode</label>
//                     <input type="text" placeholder='Enter your postcode' className='p-2 rounded-md w-full bg-white' value={location?.postcode}/>
//                   </div>
//                 </div>
//                 <div className='flex w-full gap-5'>
//                   <div className='flex flex-col space-y-1 w-full'>
//                     <label htmlFor="">Country</label>
//                     <input type="text" placeholder='Enter your country' className='p-2 rounded-md w-full bg-white' value={location?.country}/>
//                   </div>
//                   <div className='flex flex-col space-y-1 w-full'>
//                     <label htmlFor="">Phone No</label>
//                     <input type="text" placeholder='Enter your Number' className='p-2 rounded-md w-full bg-white' />
//                   </div>
//                 </div>
...
//                     <input type="text" placeholder='Enter code' className='p-2 rounded-md w-full bg-white'/>
    ...
    <div className="mt-10 max-w-6xl mx-auto mb-5 px-4 md:px-0">
      {cartItem.length > 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-20 mt-10">
            ...
            <div className="bg-gray-100 rounded-md p-7 space-y-2">
              ...
              <input
                ...
                value={location?.county || ""}
              />
              <button onClick={getLocation} className="bg-red-500 text-white px-3 py-2 rounded-md mt-3">
                Detect Location
              </button>
            </div>

            {/* Bill Details */}
            <div className="bg-white border border-gray-100 shadow-xl rounded-md p-7 space-y-2">
              <h1 className="text-gray-800 font-bold text-xl">Bill details</h1>
        ...
        <div className="flex flex-col gap-3 justify-center items-center h-[600px]">
          ...
          <img src={emptyCart} alt="" className="w-[400px]" />
          <button onClick={() => navigate("/products")} className="bg-red-500 text-white px-3 py-2 rounded-md">
            Continue Shopping
          </button>
        </div>
      )}
