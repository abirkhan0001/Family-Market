...
//       );
//       setSingleProduct(res.data); // API response সরাসরি set করা
//     } catch (error) {
//       console.log(error);
//     }
//   };
...
//   useEffect(() => {
//     getSingleProduct();
//     window.scrollTo(0, 0); // Page top এ scroll
//   }, []);
...
// import Loading from "../../assets/Material wave loading.json";
// import Breadcrums from "../Breadcrums";
// import { getData } from "../../context/DataContext"; // Cart context

// const SingleProduct = () => {
//   const params = useParams();
//   const [singleProduct, setSingleProduct] = useState(null);

//   const { addToCart } = getData(); // cart context থেকে addToCart function পাচ্ছি
...
//             <label htmlFor="" className="text-sm font-medium text-gray-700"></label>
//             <input type="number" min={1} className="w-20 border-gray-300 rounded-lg px-3 py-1 focus:outline-none focus:ring-red-500"/>
//           </div>
