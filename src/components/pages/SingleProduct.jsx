    ...
    <div className="px-4 md:px-10 py-6">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mt-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* Price Section */}
          <p className="text-2xl text-red-600 font-bold">Discount Price: ${discountedPrice}</p>
          <p className="line-through text-gray-500">Original Price: ${singleProduct.price}</p>
          <p className="text-green-700 font-semibold">{discountPercent}% OFF</p>

          <p className="text-gray-700">{singleProduct.description}</p>
          <p className="text-sm text-gray-500">Category: {singleProduct.category}</p>
