    ...
    <div className='bg-white py-3 shadow-2xl px-4 md:px-0'>
      <div className='max-w-5xl mx-auto flex justify-between items-center'>
        ...
        <div className='flex gap-7 items-center'>
            <Link to={'/'}><h1 className='font-bold text-3xl'><span className='text-red-500 font-sarif'>F</span>amily <span className='text-red-500 font-sarif'>M</span>arket</h1></Link>
            ...
            {
              openDropdown ? <div className='w-[250px] h-max shadow-2xl z-50 bg-white fixed top-16 left-60 border-2 p-5 border-gtray-100 rounded-md'>
                <h1 className='font-semibold mb-4 text-xl flex justify-between'>Change Lokation<span onClick={toggleDropdown}><CgClose/></span></h1>
        ...
        <nav className='flex gap-7 items-center'>
            ...
            <div className='hidden md:block'>
                <SignedOut>
                    <SignInButton className="bg-red-500 text-white px-3 py-1 rounded-md cursor-pointer hover:bg-red-800"/>
                </SignedOut>
                <SignedIn>
                    <UserButton />
                </SignedIn>
